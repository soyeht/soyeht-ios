    ...
    targets: [
        ...
        .testTarget(
            ...
            resources: [
                ...
                // Mobile owner-present C1 - assertion wire fields only (theyos -> Swift)
                ...
                .copy("HouseholdFixtures/OwnerWebauthn/owner_webauthn_add_credential_wire_vectors.json"),
                ...
                // ClawUnavailableReasonCode - claw installability reason wire contract (theyos core-rs -> Swift)
