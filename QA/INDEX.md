...
For pairing changes, also use [distributed-build acceptance](domains/production-pairing-acceptance.md).
`make qa-ios-export` checks the actual signed IPA and exercises refusal controls;
it does not replace physical device, upgrade-history or TestFlight coverage.
...
| Pairing on distributed builds | [production-pairing-acceptance.md](domains/production-pairing-acceptance.md) | Artifact + behavioral coverage below | release | assisted | Yes |
...
| Soyeht MCP Automation | [soyeht-mcp-automation.md](domains/soyeht-mcp-automation.md) | ST-Q-MCPA-001..164 | full | auto + assisted | No |
...
|------|-------|-----------|--------|
| 2026-08-22 | **MCP 2.0 PR #56 merge gate** (signed commit provenance, 16 security probes including physical keyboard after persistent reattach, natural-language 3-agent collaboration, physical Backspace collision ring, broker arbitration, strict UI cleanup) | PASS — independent review pending | [report](runs/2026-08-22-mcp2-merge-gate/report.md) |
