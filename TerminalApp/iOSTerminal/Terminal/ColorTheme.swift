...
enum ColorTheme: String, CaseIterable, Identifiable {
    ...
    // MARK: - ANSI Palette (Single Source of Truth)
    ...
    var swiftUIPalette: [SwiftUI.Color] {
    ...
    private static func rgb8(from hex: String) -> (UInt8, UInt8, UInt8) {
