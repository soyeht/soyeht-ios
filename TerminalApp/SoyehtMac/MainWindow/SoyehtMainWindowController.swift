    ...
    func renameWorkspaces(
        ...
        for id in byID {
            guard let workspace = store.workspace(id),
                  store.workspace(id, isInWindow: windowID),
