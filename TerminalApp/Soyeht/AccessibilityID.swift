...
enum AccessibilityID {
    ...
    enum Settings {
        ...
        static let mobileClawVPNButton = "soyeht.settings.mobileClawVPNButton"
        static let mobileClawVPNAuthorizeButton = "soyeht.settings.mobileClawVPN.authorizeButton"
        static let mobileClawVPNConfigState = "soyeht.settings.mobileClawVPN.configState"
        static let mobileClawVPNStatusLabel = "soyeht.settings.mobileClawVPN.statusLabel"
