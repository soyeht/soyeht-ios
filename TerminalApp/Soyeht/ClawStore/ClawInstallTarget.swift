...
///
/// PR-3 introduces this type so the iOS Claw Store stops speaking
/// `ClawAPITarget` vocabulary at the View/route layer. Every iOS entry
/// point (the Home Claw Store button, the server picker, the catalog
/// rows) hands one of these to the resolver, which decides the concrete
/// wire path.
///
