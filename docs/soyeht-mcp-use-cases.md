...
| UC-03 | MCP lists all automation tools. | Direct MCP | Tool list includes `open_workspace`, `open_panes`, `create_worktree_panes`, `agent_race_panes`, and `send_pane_input`. | PASS | All five expected tools listed. |
