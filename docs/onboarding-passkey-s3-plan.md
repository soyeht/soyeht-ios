...
- **Pre-flip gates** (apply before flipping enforcement): double-prepare ✅,
  ...
  platform-hint prep ✅, owner-auth v2 rollout/rollback control ✅, and
  env/Nix rollout wiring + required-check path-filter coverage ✅.
